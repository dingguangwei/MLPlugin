document.getElementById("main6Total").style.visibility="hidden";
document.getElementById("main6Total").style.display="none";
// document.getElementById("model_path").style.display="none";
//################################################################################################
//
//                                     1、创建图表
//
...
function genData4(arr4name, arr4item, arr4value){
	...
	for(var i=0; i<arr4value.length; i++){
		...
		console.log("series4 ["+i+"] : "+arr4value[i]);
		series4.push(item);
	}
...
function generateURL() {
	...
	wPath = document.forms[s[0]][s[8]].value
	if(wPath=="" || wPath==null) {
		url+="mWpath=";
	} else {
		url+="mWpath="+wPath;
	}
	console.log("默认存储模型到 F:/bc/J48.model");
...
$(document).ready(function(){
	$("#trainButton").click(function(){
		...
		if(generateURL()){
			console.log("请求训练 url："+url);
			document.getElementById("main6Total").style.display="";
			document.getElementById("main6Total").style.visibility="visible";
			myChart2.showLoading();
			myChart4.showLoading();
			trainRun(url);
			// document.getElementById("model_path").style.display="";
		}
	});
});
